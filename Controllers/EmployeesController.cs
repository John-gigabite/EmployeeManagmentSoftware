...
namespace employeeManagmentSoftware.Controllers
{
    public class EmployeesController : Controller
    {
        private readonly employeeManagmentSoftwareContext _context;

        public EmployeesController(employeeManagmentSoftwareContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'employeeManagmentSoftwareContext.Employee'  is null.");
            }
            var employee = await _context.Employee.FindAsync(id);
            if (employee != null)
            {
